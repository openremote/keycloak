      ...
      <form action="${url.loginAction}" class=" ${properties.kcFormClass!}" id="kc-totp-settings-form" method="post">
        <div class="${properties.kcFormGroupClass!}">
          <div class="input-field ${properties.kcLabelWrapperClass!}">
            <input type="text" id="totp" name="totp" autocomplete="one-time-code" class="${properties.kcInputClass!}" aria-invalid="<#if messagesPerField.existsError('totp')>true</#if>" inputmode="numeric" dir="ltr"/>
        ...
        <div class="${properties.kcFormGroupClass!}">
          <div class="input-field ${properties.kcLabelWrapperClass!}">
            <input type="text" class="${properties.kcInputClass!}" id="userLabel" name="userLabel" autocomplete="off" aria-invalid="<#if messagesPerField.existsError('userLabel')>true</#if>" dir="ltr"/>
