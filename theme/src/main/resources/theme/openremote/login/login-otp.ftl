    ...
    <form id="kc-otp-login-form" class="${properties.kcFormClass!}" action="${url.loginAction}"
      ...
      <div class="${properties.kcFormGroupClass!}" style="margin-top: 24px;">
        <div class="input-field ${properties.kcLabelWrapperClass!}">
          <input id="otp" name="otp" autocomplete="off" type="text" class="input-field ${properties.kcInputClass!}" autofocus aria-invalid="<#if messagesPerField.existsError('totp')>true</#if>" dir="ltr" />
